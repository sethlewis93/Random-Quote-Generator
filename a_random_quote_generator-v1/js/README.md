...
The quote generator consists of (a.) a library of quotations from classic literature, programmers writing about programming, and musicicans; (b.) a function (getRandomQuote) that randomly selects a quotation object at it's respective index number within the "quotations" arry; (c.) a function (printQuote) that calls the getRandomQuote function, use the returned quote object to build a string of HTML and quote properties, then uses that string to display a random quote in the browser; and (d.) a "click" event listener that I inherited with the project when it was assigned.

To use: simply open the web page, view the quotation, and select "Show another quote" at the top right-hand corner of the page.